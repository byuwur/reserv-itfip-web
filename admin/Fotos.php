...
if (mysqli_num_rows($Consulta)==0){
		...
		<div class="container">
			...
			<div class="row">
				<div class="animar4 col-xs-12 col-sm-3 col-sm-offset-6">
					<a href="CrearCancha.php" style="margin-top: 35px; height: 50px;" class="btn btn-danger btn-raised">CANCELAR</a>
				</div>
	...
	if (isset($_POST['Crear'])) {
		...
		$Tarifa = $_POST['Valor_Txt'];
		$Id_Admin = $_POST['Id_Admin'];
		$sql = $conex->query( "INSERT INTO canchas VALUES('$Id_Cancha','$NombreCancha','$Telefono','$HoraA','$HoraC','$Direccion','$Barrio','$Tarifa','$Info','$Ciudad','$Id_Admin','$CodigoAsociado')" );
		if ($sql){
		                ...
		                <div class='row'>
		                  <div class='col-sm-8 col-sm-offset-2'>
		                    <form action='' method='GET'>
		                    	<script>alert('Cancha registrada');parent.window.location.reload(true);</script>
		                    </form>
		                  </div>
		                </div>
		              </div>
	                ...
	                <div class='row'>
	                  <div class='col-sm-8 col-sm-offset-2'>
	                    <form action='' method='GET'>
	                    	...
	                    	echo '
	                    	<div class="col-xs-12 col-sm-6">
								<a style="height: 50px;" href="#" data-dismiss="modal" aria-hidden="true" class="btn btn-danger btn-raised" >Aceptar</a>
							</div>
	                    	';
	                    	echo"
	                    </form>
