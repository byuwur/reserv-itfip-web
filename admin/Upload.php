<?php 		
	...
	$cmdBorrarDir = "rm -R Imagenes_Canchas/$Id_Cancha/1.jpg";
	...
	$Registro_Evento = "UPDATE imagen_cancha SET Imagen1='$Ruta2', canchas_IDCANCHA='$Id_Cancha' where canchas_IDCANCHA='$Id_Cancha'";
