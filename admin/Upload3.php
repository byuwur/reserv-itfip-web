<?php 		
	...
	$cmdBorrarDir = "rm -R Imagenes_Canchas/$Id_Cancha/3.jpg";
	...
	$Registro_Evento = "UPDATE imagen_cancha SET Imagen3='$Ruta2', canchas_IDCANCHA='$Id_Cancha' where canchas_IDCANCHA='$Id_Cancha'";
