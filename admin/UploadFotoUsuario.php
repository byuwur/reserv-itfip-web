<?php 		
	...
	@mkdir("Imagenes_Admin/$Id_Cancha/");
	@chmod("Imagenes_Admin/*", 777);
			
	$randon = 1;
			
	$cmdBorrarDir = "rm -R Imagenes_Admin/$Id_Cancha/*";
	shell_exec($cmdBorrarDir);
			
	$extension = end(explode(".", $_FILES['archivo']['name']));
	$Ruta = "Imagenes_Admin/".$Id_Cancha."/".basename($randon).$extension.".jpg"; 

	$Ruta2 = "http://reservelapp.com/admin/Imagenes_Admin/".$Id_Cancha."/".basename($randon).$extension; 
